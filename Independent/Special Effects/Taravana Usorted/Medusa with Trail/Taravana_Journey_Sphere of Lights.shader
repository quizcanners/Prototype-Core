Shader "Taravana/Journey/Sphere of Medusa"
{
	...
	SubShader{
      ...
      half4 frag(vertexToFragment o) : COLOR{
        ...
        float2 screenUV_Str = StretchedScreenUV(screenUV);
        ...
        float3 gyrPos = float3(gridIndex * 351.345 , _Taravana_Time*3);
      ...
      //  grid.x += gyroid * 0.5;
       // o.texcoord.y += gyroid*0.01;
        ...
        float4 col = (bg *  bg + vertLine* vertLine) * grad * dotprod * dotprod * o.color;
