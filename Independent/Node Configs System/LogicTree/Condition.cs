...
namespace QuizCanners.IsItGame.NodeNotes
{
    ...
    [DerivedList(typeof(ConditionLogicBool), typeof(ConditionLogicInt))] 
    public abstract class ConditionLogic : TriggerIndexBase
    {
    ...
    public class ConditionLogicBool : ConditionLogic, IBoolTriggerIndex {
    ...
    public class ConditionLogicInt : ConditionLogic, IIntTriggerIndex {
